  ...
  return (
    <div className={styles['main']}>
          ...
          <tbody className={styles['table__body']}>
            {new Array(4).fill('').map((_, key) => (
              <tr key={key} className={styles['table__body-row']}>
                ...
                <td className={styles['table__body-td']}>
                  <div className={styles['table__information']}>
                    <div className={styles['table__information-product']}>
                      ...
                      <p className={styles['table__information-product-name']}>Торт “Чизкейк”</p>
                      <p className={styles['table__information-product-category']}>Кондитерская</p>
                    </div>
                  </div>
                </td>

                <td className={styles['table__body-td']}>
                  <p className={styles['table__text']}>11.02.2022</p>
                </td>

                <td className={styles['table__body-td']}>
                  <p className={styles['table__text']}>кг.</p>
                </td>
                ...
                <td className={styles['table__body-td']}>
                  {isArchive && (
                    <div className={cn(styles['table__select'], styles['archive'])}>
                      <div></div>
      ...
      <div className={styles['footer']}>
        <p className={styles['footer__title']}>Показано 4 товара из 180</p>
